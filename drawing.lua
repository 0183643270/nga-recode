...
local drawingFontsEnum = {
    ...
    [4] = Font.new('rbxassetid://12187371840'),
}

function getFontFromIndex(fontIndex: number): Font
...
drawingUI.Parent = game.Players.LocalPlayer.PlayerGui
...
function Drawing.new(drawingType)
    ...
    if drawingType == 'Line' then
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(lineObj[index]) == 'nil' then
                    return
                end
    ...
    elseif drawingType == 'Text' then
        ...
        local textLabel, uiStroke =
            Instance.new('TextLabel'), Instance.new('UIStroke')
        ...
        textLabel:GetPropertyChangedSignal('TextBounds'):Connect(function()
            ...
            textLabel.Position = UDim2.fromOffset(
                textObj.Position.X
                    + (if not textObj.Center then offset.X else 0),
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(textObj[index]) == 'nil' then
                    return
                end
    ...
    elseif drawingType == 'Circle' then
        ...
        circleFrame.BackgroundTransparency = (
            if circleObj.Filled
                then convertTransparency(circleObj.Transparency)
                else 1
        )
        ...
        circleFrame.Parent, uiCorner.Parent, uiStroke.Parent =
            drawingUI, circleFrame, circleFrame

        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(circleObj[index]) == 'nil' then
                    return
                end
                ...
                elseif index == 'Transparency' then
                    ...
                    circleFrame.BackgroundTransparency = (
                        if circleObj.Filled then transparency else 1
                    )
                    uiStroke.Transparency = transparency
                elseif index == 'Color' then
    ...
    elseif drawingType == 'Square' then
        ...
        local squareFrame, uiStroke =
            Instance.new('Frame'), Instance.new('UIStroke')

        squareFrame.Name = drawingIndex
        squareFrame.BorderSizePixel = 0
        squareFrame.BackgroundTransparency = (
            if squareObj.Filled
                then convertTransparency(squareObj.Transparency)
                else 1
        )
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                ...
                elseif index == 'Transparency' then
                    ...
                    squareFrame.BackgroundTransparency = (
                        if squareObj.Filled then transparency else 1
                    )
                    uiStroke.Transparency = transparency
                elseif index == 'Color' then
                    uiStroke.Color = value
    ...
    elseif drawingType == 'Image' then
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(imageObj[index]) == 'nil' then
                    return
                end
    ...
    elseif drawingType == 'Quad' then
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(quadObj[index]) == 'nil' then
                    return
                end
    ...
    elseif drawingType == 'Triangle' then
        ...
        return setmetatable(table.create(0), {
            __newindex = function(_, index, value)
                if typeof(triangleObj[index]) == 'nil' then
                    return
                end
